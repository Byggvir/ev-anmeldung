...
<head>
    ...
    <title>EvKP Rheinbach: Bestätigen der Gottesdienst-Anmeldung</title>
...
<?php
    ...
    if ( $key = $matches[0] && $t->confirm($key) && $t->conn->affected_rows > 0 ) {

 ?>
        <p class="success">Anmeldung bestätigt!</p>


<?php
 } else {
 ?>
        <p class="failure">Die Anmeldung konnte nicht bestätigt werden!<br />Der Schlüssel ist nicht bekannt.<br />Bitte erneut anmelden.</p>
        <address>
